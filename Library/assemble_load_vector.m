function F = assemble_load_vector(msh, current_density_per_element, shape_function_object)
...
for k_element = 1:number_of_elements
    for k_test = 1:3
        for k_quadrature = 1:number_of_quadrature_points
            test_function_value = ...
                shape_function_object.get_global_value(...
            ...
            F(row) = F(row) + ...
                ...
                current_density_per_element(k_element) * ...
                test_function_value * ...
